...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        FCV_DutchLadyMail_Model.Common.IdentityUser Identity = (FCV_DutchLadyMail_Model.Common.IdentityUser)Session["Identity"];
        if (Identity == null)
        {
            return false;
        }
    ...
    public override void SetConfig()
    {
        ...
        BaseDir = HttpContext.Current.Server.MapPath("/");
